...
{
    /// <summary>
    /// Transcriptions layer fragment.
    /// Tag: <c>fr.it.vedph.tgr.transcr</c>.
    /// </summary>
    /// <seealso cref="ITextLayerFragment" />
    [Tag("fr.it.vedph.tgr.transcr")]
    public sealed class TranscrLayerFragment : ITextLayerFragment
    {
        /// <summary>
        ...
        /// </summary>
        public List<TranscrEntry> Entries { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="TranscrLayerFragment"/>
        /// class.
        /// </summary>
        public TranscrLayerFragment()
        {
            Entries = new List<TranscrEntry>();
        }
        ...
        public IEnumerable<DataPin> GetDataPins(IItem item = null)
        {
            ...
            if (Entries?.Count > 0)
            {
                foreach (TranscrEntry entry in Entries)
                {
                    // fr-language
